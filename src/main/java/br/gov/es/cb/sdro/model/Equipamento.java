...
@NamedQueries({
    ...
    @NamedQuery(name = "Equipamento.UpdateEstadoEquipamento", query = "UPDATE Equipamento SET isalocado=true, idviatura = :idviatura WHERE idequipamento = :idequipamento"),
    @NamedQuery(name = "Equipamento.liberaEquipamento", query = "UPDATE Equipamento SET isalocado=false, idviatura = null WHERE idequipamento = :idequipamento"),
