 ...
 * @author Patrícia
 */
public class TelaEquipamentosAlocacaoSCO extends javax.swing.JFrame {
    ...
    public TelaEquipamentosAlocacaoSCO(List<Integer> lstIdEquipamentos){
        initComponents();
    ...
    private void btnSalvarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSalvarActionPerformed
        ...
        TelaAlocacaoSCO tela = TelaAlocacaoSCO.getInstancia().getInstancia();
